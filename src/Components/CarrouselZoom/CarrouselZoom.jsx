...
function CarrouselZoom(props) {
  ...
  return (
    <Fragment>
      <div className={visibiliti ? "content-carousel carrouselVisible" :"content-carousel carouselHidden"}>
      <button className="closeButton" onClick={()=>{props.visibilitiChange(!visibiliti)}}>X</button>
        <Carousel>
